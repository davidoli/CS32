...
//  Homework 3
//
//  Created by David Li on 2/11/17.
...
int countIncludes(const double a1[], int n1, const double a2[], int n2)
{
    ...
    if(a1[0] == a2[0])
        ...
        return countIncludes(a1+1, n1-1, a2, n2);     //recursively navigate array until there's a match
}

// Exchange two doubles
void exchange(double& x, double& y)  // 15 18 26 31
{
    double t = x;
    x = y;
    y = t;
...
void order(double a[], int n)
{
    ...
    separate(a, n, mid, firstNotGreater, firstLess);    //use separator function to find middle and recursively use order
    
    order(a, mid);
    order(a+firstNotGreater, n-firstLess);
